...
const MetamaskSection = ({lightBg, id, imgStart, topLine, lightText, headline, darkText, description, buttonLabel, img, alt, primary, dark, dark2}) => {
    return (
        <>
                        ...
                        <Column1>
                            <TextWrapper>
                                ...
                                <ButtonWrap>
                                    ...
                                    offset={-80}
                                    exact="true"
                                    href="//www.metamask.io/download" target="_blank" aria-label="Metamask"
                                    >
                                        {buttonLabel}
                                    </ButtonExternal>
                                </ButtonWrap>
